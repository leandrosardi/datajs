BlackStack::Extensions::add ({
    ...
    :description => 'The Datas.Js is a little HTML widget to add remove contact infrormation items, reminders, and tasks lists.',

    # setup the url of the repository for installation and updates
    :repo_url => 'https://github.com/leandrosardi/datasjs',
    :repo_branch => 'main',
    ...
    :css_files => [
        '/datasjs/css/datas.css',
    ],

    # define JS files to add to the header of every page
    :js_files => [
        '/datasjs/javascripts/datas.min.js',
    ],
})