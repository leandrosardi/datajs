datasJs = {
    ...
    add_item: function(parent_items, v) {
        ...
        datasJs.components[parent_items.id].items.push(v);
...
console.log ('datasjs.button.link = ' + button.link.toString());
console.log ('datasjs.v.value = ' + v.value.toString());            
            // 
        ...
        datasJs.apply_item_behaviour(parent_items, v.id);
    },
    ...
    show_form: function(parent_buttons, type) {
        ...
        datasJs.toggle_add_button(parent_buttons);
    },
    ...
    on_add_item: function(parent_buttons, parent_items) {
        ...
        if (datasJs.events[parent_items.id+".on_add_item"]) {
            // call the function
            datasJs.events[parent_items.id+".on_add_item"](type, value);
        } else {
            // add the data
            v = {
                id: datasJs.uuidv4(),
    ...
    on_remove_item: function(parent_items, item_id) {
        if (datasJs.events[parent_items.id+".on_remove_item"]) {
            // call the function
            datasJs.events[parent_items.id+".on_remove_item"](item_id);
        } else {
            datasJs.remove_item(parent_items, item_id);
        }
    },
    ...
    on_strikethrough_item: function(parent_items, item_id) {
        if (datasJs.events[parent_items.id+".on_strikethrough_item"]) {
            // call the function
            datasJs.events[parent_items.id+".on_strikethrough_item"](item_id);
        } else {
    ...
    draw: function(parent_buttons, parent_items, h) {
        ...
        if (h['on_add_item'] != null) {
            datasJs.events[parent_items.id+".on_add_item"] = h['on_add_item'];
        }
        if (h['on_remove_item'] != null) {
            datasJs.events[parent_items.id+".on_remove_item"] = h['on_remove_item'];
        }
        if (h['on_strikethrough_item'] != null) {
            datasJs.events[parent_items.id+".on_strikethrough_item"] = h['on_strikethrough_item'];
        }
        ...
        $(parent_buttons).find('.add-data-field').keyup(function(e) {
            if (datasJs.toggle_add_button(parent_buttons)) {
