datasJs = {
    ...
    draw: function(parent_buttons, parent_items, h) {
        ...
        // strikethrough item when click on .btn-strikethrough-data button
        $(parent_items).find('.btn-strikethrough-data').click(function() {
            datasJs.on_strikethrough_item(parent_items, $(this).attr('data-id-item'));
        });

        // copy to clipboard when click on .btn-copy-data button
        $(parent_items).find('.btn-copy-data').click(function() {
            // get id_lead
            ...
            setTimeout(function() {
                $(parent_items).find('.btn-copy-data').find('i').removeClass('icon-ok').addClass('icon-copy');
            }, 1000);
        });
    },
